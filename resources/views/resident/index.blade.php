<x-layout>
  ...
  <section class="md:pt-36 py-24 bg-neutral-200">
    <div class="flex flex-col gap-7 justify-center items-center pt-10">
      ...
      <p class="w-full max-w-lg text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro quis recusandae voluptatum enim nam, ad, odio quae magnam excepturi, deleniti conse.</p>
    </div>
  </section>
  <!-- Services -->
