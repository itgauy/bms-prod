        ...
        <div class="md:space-y-2.5 space-y-1.5">
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
              ...
              <label for="remember-me" class="text-sm ms-3">Remember me?</label>
            </div>
            <!-- Forgot Password -->
      ...
      <div
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
          ...
          <div class="overflow-y-aut p-7 flex gap-7">
            <a href="{{ route('register') }}" class="btn btn-secondary w-full p-14 flex flex-col justify-center items-center">
              Illustration diney
