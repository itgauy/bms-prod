...
<body class="bg-neutral-50">
  ...
  <header class="fixed top-0 w-full bg-white shadow-lg shadow-neutral-300/10 z-40">
    <nav class="md:p-6 px-4 md:py-6 py-4 flex items-center justify-between w-full md:px-16">
      ...
      <div class="items-center gap-4 lg:flex hidden">
        ...
        <a href="{{ route('register-1') }}" class="btn btn-primary">Register
  ...
  <footer
    ...
    <div class="space-y-4">
      ...
      <p class="w-full max-w-md text-neutral-300">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis
        accusantium soluta commodi ab, praesentium harum ad id remum harum ad id.</p>
    </div>
    <!-- Links if any -->
