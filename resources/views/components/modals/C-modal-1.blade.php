<div id="C-modal-1"
  ...
  role="dialog" tabindex="-1" aria-labelledby="C-modal-1-label">
  <div
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
      ...
      <div class="flex justify-between items-center py-5 px-7 border-b border-blue-500/10">
        <h3 id="C-modal-1-label">
          Medical Fianancial Assistance
        </h3>
        <button type="button" class="btn btn-ghost text-gray-700 px-2.5" aria-label="Close" data-hs-overlay="#C-modal-1">
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 gap-x-5 md:gap-y-6 gap-y-5">
          ...
          <div class="md:space-y-2.5 space-y-1.5">
            ...
            <select id="type_of_assistance" name="type_of_assistance"
              ...
              <option value="medical-financial-assisant-only" {{ old('type_of_assistance') == 'medical-financial-assisant-only' ? 'selected' : '' }}>Medical Financial Assistant Only</option>
              <option value="dswd-medical-financial-assistant" {{ old('type_of_assistance') == 'dswd-medical-financial-assistant' ? 'selected' : '' }}>DSWD Medical Financial Assistant</option>
              <option value="malasakit-program" {{ old('type_of_assistance') == 'malasakit-program' ? 'selected' : '' }}>Malasakit Program</option>
              <option value="mayor-joy-belmonte" {{ old('type_of_assistance') == 'mayor-joy-belmonte' ? 'selected' : '' }}>Mayor Joy Belmonte</option>
            </select>
          ...
          <div class="md:col-span-2 col-span-1 flex justify-end gap-4 mt-6">
            <button aria-label="Close" data-hs-overlay="#C-modal-1" class="btn btn-secondary">Cancel</button>
