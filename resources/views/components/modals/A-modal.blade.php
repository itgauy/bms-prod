<div id="A-modal"
  ...
  role="dialog" tabindex="-1" aria-labelledby="A-modal-label">
  <div
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
      ...
      <div class="flex justify-between items-center py-5 px-7 border-b border-blue-500/10">
        ...
        <button type="button" class="btn btn-ghost text-gray-700 px-2.5" aria-label="Close" data-hs-overlay="#A-modal">
      ...
      <div class="p-7 flex flex-wrap jsutify-center items-center gap-7">
        <button aria-haspopup="dialog" aria-expanded="false" aria-controls="A-modal-1" data-hs-overlay="#A-modal-1" data-hs-overlay-options='{
          ...
          <p class="text-center text-blue-500 font-medium md:text-2xl text-xl">Business Permit</p>
        </button>
      </div>
    </div>
  </div>
