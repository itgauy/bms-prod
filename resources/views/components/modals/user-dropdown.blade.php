<div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-xl shadow-stone-300/30 rounded-xl p-2 space-y-0.5 mt-2" role="menu" aria-orientation="vertical" aria-labelledby="user-dropdown">
  <div class="py-5 flex flex-col justify-center items-center gap-3">
    <span class="inline-flex items-center justify-center size-12 text-sm font-semibold rounded-full leading-none border border-stone-300 bg-stone-600 text-white">
      JC
    </span>
