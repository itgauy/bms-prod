<div class="flex flex-col justify-between h-full">
  <div class="space-y-12">
    ...
    <nav class="flex flex-col items-start gap-1" aria-label="Tabs" role="tablist">
      <button type="button" class="flex w-full items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-stone-700 hover:bg-slate-100 focus:outline-none transition duration-300 hs-tab-active:bg-blue-100/50 hs-tab-active:text-blue-600" id="dashboard-item" data-tab-id="dashboard" aria-selected="true" data-hs-tab="#dashboard" aria-controls="dashboard" role="tab">
