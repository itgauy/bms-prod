<div>
  ...
  <button type="button" class="lg:hidden flex shrink-0 btn btn-secondary px-2 py-2" aria-haspopup="dialog"
    aria-expanded="false" aria-controls="admin-sidebar" data-hs-overlay="#admin-sidebar">
...
<div class="flex items-center gap-3">
  ...
  <div class="hs-dropdown relative inline-flex">
    <button id="hs-dropdown-with-title" type="button"
      class="inline-flex items-center justify-center size-8 text-[10px] font-semibold rounded-full leading-none border border-gray-300 bg-blue-500 text-white focus:ring-2 focus:ring-blue-300 transition duration-300 ease-in-out"
    ...
    <div
      ...
      <div class="py-5 flex flex-col justify-center items-center gap-3">
        ...
        <div class="text-center">
          <h4 class="text-md">Super Admin</h4>
          <p class="text-xs">superadmin@email.com</p>
        </div>
      </div>
      <div class="mt-2 py-2 first:pt-0 last:pb-0">
        ...
        <form action="{{ route('logout') }}" method="post">
          @csrf
          <button type="submit" aria-haspopup="dialog" aria-expanded="false" aria-controls="logout-admin-modal"
            data-hs-overlay="#logout-admin-modal"
