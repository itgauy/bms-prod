<!-- Modal Structure -->
<div id="delete-announcement" class="bg-blue-950/30 hidden size-full fixed top-0 start-0 z-[70] overflow-x-hidden overflow-y-auto custom-scrollbar transition-all duration-300 ease-in-out" role="dialog" tabindex="-1" aria-labelledby="delete-announcement-label">
  <div id="delete-announcement-modal-body" class="mt-0 opacity-0 transition-all duration-300 ease-in-out sm:max-w-sm w-full sm:w-full m-3 sm:mx-auto">
    <!-- Modal Card -->
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
      ...
      <div class="flex flex-col gap-4 items-center justify-center text-center p-7">
        ...
        <p class="text-center">Are you sure you want to delete the announcement?</p>
      </div>
      <!-- Modal Content -->
      <div class="overflow-y-auto pb-7 flex justify-center gap-7">
        <div class="items-center gap-4 flex">
          <button class="btn btn-ghost" id="delete-announcement-modal-close">Cancel</button>
...
<script>
  ...
  function openDeleteAnnouncementModal() {
    const modalOverlay = document.getElementById("delete-announcement");
    const modalBody = document.getElementById("delete-announcement-modal-body");
  ...
  document.getElementById("delete-announcement-modal-close").addEventListener("click", closeDeleteAnnouncementModal);
</script>