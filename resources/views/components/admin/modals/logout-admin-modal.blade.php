  ...
  <div
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
      ...
      <div class="flex flex-col gap-4 items-center justify-center text-center p-7">
        <h4 id="decline-confirm-label">
          Confirmation
        </h4>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
          stroke="currentColor" class="text-red-500 size-24">
      ...
      <!-- Modal Content -->
      <div class="overflow-y-auto px-7 pb-7 flex justify-center gap-7">
        <div class="items-center gap-4 flex">
          <button class="btn btn-ghost" aria-haspopup="dialog" aria-expanded="false" aria-controls="logout-admin-modal"
            data-hs-overlay="#logout-admin-modal">Cancel</button>
