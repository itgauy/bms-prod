<div id="archive-confirm"
  ...
  role="dialog" tabindex="-1" aria-labelledby="archive-confirm-label">
  <div
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
      ...
      <div class="flex flex-col gap-4 items-center justify-center text-center p-7">
        ...
        <p class="text-center">Are you sure you want to archive the announcement?</p>
      </div>
      <!-- Modal Content -->
      <div class="overflow-y-auto pb-7 flex justify-center gap-7">
        <div class="items-center gap-4 flex">
          <button class="btn btn-ghost" aria-haspopup="dialog" aria-expanded="false" aria-controls="archive-confirm"
            data-hs-overlay="#archive-confirm">Cancel</button>
