<div id="new-announcement-modal"
  ...
  role="dialog" tabindex="-1" aria-labelledby="new-announcement-modal-label">
  <div
    ...
    <div class="flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
      ...
      <div class="flex justify-between items-center py-5 px-7 border-b border-blue-500/10">
        <h3 id="new-announcement-modal-label">
          Add Announcement
        </h3>
        <button type="button" class="btn btn-ghost text-gray-700 px-2.5" aria-label="Close" data-hs-overlay="#new-announcement-modal">
      ...
      <div class="p-7">
        <form action="" class="md:space-y-6 space-y-5">
          ...
          <div class="md:col-span-2 col-span-1 flex justify-end gap-4 mt-6">
            <button type="button" class="btn btn-secondary" aria-label="Close" data-hs-overlay="#new-announcement-modal">Cancel</button>
